...
function PriceBox({ title1, title2, context, price }: Typess) {
    return (
            <div className={`text-white border-1 bg-black border-black ${title1 === "Premium" && 'bg-dark-gradient border-3'} mt-10 p-10 rounded-xl w-[280px] md:w-[400px] h-auto md:h-[400px]"}`}>
